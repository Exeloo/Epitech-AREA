...
Serializer<GgetProviderOAuthStateReq> _$ggetProviderOAuthStateReqSerializer =
    new _$GgetProviderOAuthStateReqSerializer();
...
class _$GgetProviderOAuthStateReqSerializer
    implements StructuredSerializer<GgetProviderOAuthStateReq> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GgetProviderOAuthStateReq';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GgetProviderOAuthStateReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GgetProviderOAuthStateVars)),
      'operation',
      serializers.serialize(object.operation,
          specifiedType: const FullType(_i4.Operation)),
      'executeOnListen',
    ...
    if (value != null) {
      result
        ..add('optimisticResponse')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GgetProviderOAuthStateData)));
    }
    value = object.updateCacheHandlerKey;
    if (value != null) {
      result
  ...
  @override
  GgetProviderOAuthStateReq deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GgetProviderOAuthStateReqBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'vars':
          result.vars.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(_i3.GgetProviderOAuthStateVars))!
              as _i3.GgetProviderOAuthStateVars);
          break;
        case 'operation':
          result.operation = serializers.deserialize(value,
              specifiedType: const FullType(_i4.Operation))! as _i4.Operation;
        ...
        case 'optimisticResponse':
          result.optimisticResponse.replace(serializers.deserialize(value,
                  specifiedType:
                      const FullType(_i2.GgetProviderOAuthStateData))!
              as _i2.GgetProviderOAuthStateData);
          break;
        case 'updateCacheHandlerKey':
          result.updateCacheHandlerKey = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
...
class _$GgetProviderOAuthStateReq extends GgetProviderOAuthStateReq {
  @override
  final _i3.GgetProviderOAuthStateVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GgetProviderOAuthStateData? Function(
          _i2.GgetProviderOAuthStateData?, _i2.GgetProviderOAuthStateData?)?
      updateResult;
  @override
  final _i2.GgetProviderOAuthStateData? optimisticResponse;
  @override
  final String? updateCacheHandlerKey;
  @override
  final Map<String, dynamic>? updateCacheHandlerContext;
  ...
  factory _$GgetProviderOAuthStateReq(
          [void Function(GgetProviderOAuthStateReqBuilder)? updates]) =>
      (new GgetProviderOAuthStateReqBuilder()..update(updates))._build();

  _$GgetProviderOAuthStateReq._(
      {required this.vars,
      required this.operation,
      this.requestId,
      this.updateResult,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        vars, r'GgetProviderOAuthStateReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, r'GgetProviderOAuthStateReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GgetProviderOAuthStateReq', 'executeOnListen');
  }

  @override
  GgetProviderOAuthStateReq rebuild(
          void Function(GgetProviderOAuthStateReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GgetProviderOAuthStateReqBuilder toBuilder() =>
      new GgetProviderOAuthStateReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    final dynamic _$dynamicOther = other;
    return other is GgetProviderOAuthStateReq &&
        vars == other.vars &&
        operation == other.operation &&
        requestId == other.requestId &&
        updateResult == _$dynamicOther.updateResult &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GgetProviderOAuthStateReq')
          ..add('vars', vars)
          ..add('operation', operation)
          ..add('requestId', requestId)
          ..add('updateResult', updateResult)
...
class GgetProviderOAuthStateReqBuilder
    implements
        Builder<GgetProviderOAuthStateReq, GgetProviderOAuthStateReqBuilder> {
  _$GgetProviderOAuthStateReq? _$v;

  _i3.GgetProviderOAuthStateVarsBuilder? _vars;
  _i3.GgetProviderOAuthStateVarsBuilder get vars =>
      _$this._vars ??= new _i3.GgetProviderOAuthStateVarsBuilder();
  set vars(_i3.GgetProviderOAuthStateVarsBuilder? vars) => _$this._vars = vars;
  ...
  _i2.GgetProviderOAuthStateDataBuilder? _optimisticResponse;
  _i2.GgetProviderOAuthStateDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??=
          new _i2.GgetProviderOAuthStateDataBuilder();
  set optimisticResponse(
          _i2.GgetProviderOAuthStateDataBuilder? optimisticResponse) =>
      _$this._optimisticResponse = optimisticResponse;
  ...
  GgetProviderOAuthStateReqBuilder() {
    GgetProviderOAuthStateReq._initializeBuilder(this);
  }

  GgetProviderOAuthStateReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _operation = $v.operation;
  ...
  @override
  void replace(GgetProviderOAuthStateReq other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GgetProviderOAuthStateReq;
  }

  @override
  void update(void Function(GgetProviderOAuthStateReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GgetProviderOAuthStateReq build() => _build();

  _$GgetProviderOAuthStateReq _build() {
    _$GgetProviderOAuthStateReq _$result;
    try {
      _$result = _$v ??
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GgetProviderOAuthStateReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
