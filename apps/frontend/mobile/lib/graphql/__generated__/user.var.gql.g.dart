  ...
  Iterable<Object?> serialize(Serializers serializers, GupdateMeVars object,
    ...
    final result = <Object?>[
      ...
      serializers.serialize(object.data,
          specifiedType: const FullType(_i2.GUserUpdateInput)),
    ];
...
class _$GupdateMeVars extends GupdateMeVars {
  @override
  final _i2.GUserUpdateInput data;

  factory _$GupdateMeVars([void Function(GupdateMeVarsBuilder)? updates]) =>
      (new GupdateMeVarsBuilder()..update(updates))._build();

  _$GupdateMeVars._({required this.data}) : super._() {
    BuiltValueNullFieldError.checkNotNull(data, r'GupdateMeVars', 'data');
  }
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is GupdateMeVars && data == other.data;
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GupdateMeVars')..add('data', data))
        .toString();
  }
}
...
class GupdateMeVarsBuilder
  ...
  _i2.GUserUpdateInputBuilder? _data;
  _i2.GUserUpdateInputBuilder get data =>
      _$this._data ??= new _i2.GUserUpdateInputBuilder();
  set data(_i2.GUserUpdateInputBuilder? data) => _$this._data = data;
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GupdateMeVars', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
