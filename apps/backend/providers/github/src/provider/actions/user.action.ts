...
export class UserAction extends BaseHttpRepository {
  ...
  @ManifestAction({
    ...
    img: "https://firebasestorage.googleapis.com/v0/b/area-444018.firebasestorage.app/o/git-icone.svg?alt=media&token=8f7182c1-21d8-45fd-9d54-dc1f3d166bbc",
    color: "#2b3137",
  ...
  @ManifestAction({
    ...
    img: "https://firebasestorage.googleapis.com/v0/b/area-444018.firebasestorage.app/o/git-icone-2.svg?alt=media&token=cf909264-b909-4394-9e77-bbf30cc4d7aa",
    color: "#2b3137",
