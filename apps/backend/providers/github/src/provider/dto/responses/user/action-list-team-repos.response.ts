...
@ManifestType()
export class Owner {
  @ManifestProperty({ type: ManifestPropertyEnum.STRING })
  login: string;

  @ManifestProperty({ type: ManifestPropertyEnum.NUMBER })
  id: number;
  ...
  @ManifestProperty({ type: ManifestPropertyEnum.BOOLEAN })
  site_admin: boolean;
}
...
export class ActionListTeamReposResponse {
  ...
  @ManifestProperty({ type: ManifestPropertyEnum.OBJECT, properties: Owner })
  owner: Owner;
